...
namespace RaidCrawler.Core.Structures
{
    public class RaidFilter
    {
        ...
        {
            if (Species == null && RareVariant == false && Form == null && Stars == null && Shiny == false && Square == false && Nature == null && TeraType == null && Gender == null && Size == null && IVBin == 0 && (RewardItems == null || RewardsCount == 0) && BatchFilters == null)
                return false;
            return true;
        }
